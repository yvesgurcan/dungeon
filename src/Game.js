    ...
    render() {
        return (
            ...
            >
                ...
                >
                    <Button>
                        <View style={Styles.RestButton}>Rest</View>
                    </Button>
                </ToolTip>
            </View>
        );
...
class RepsonsiveStatsContainer extends Component {
    render() {
        return (
            <View
                style={Styles.ResponsiveStatsContainer}
...
class Controls extends Component {
    render() {
        return <View style={Styles.ControlBlock}>{this.props.children}</View>;
    }
}
...
class Event extends Component {
    ...
    render() {
        return <View style={Styles.Event}>{this.GenerateEventText()}</View>;
    }
}
...
class CreateCharacterContainer extends Component {
    render() {
        return <View style={Styles.CreateCharacterContainer}></View>;
    }
}
    ...
    render() {
        ...
        return (
            <View style={Styles.CharacterCreateBackground}>
                ...
                <Block
                    style={{ ...Styles.PropertyLabel, paddingTop: '10px' }}
                    hidden={
