...
export const WeaponReadyBlockContainer = connect(mapStateToProps)(WeaponReadyBlock)
...
export const PlayerNameAndWeaponsContainer = connect(mapStateToProps)(PlayerNameAndWeapons)